...
const Intro = () => {
  ...
  return (
    ...
    <div className="mx-auto max-w-screen-2xl mb-44">
      ...
      <div className="absolute inset-0 w-full h-full bg-slate-900/40 lg:bg-slate-900/20 z-0 [mask-image:radial-gradient(transparent,white)] pointer-events-none" />
        ...
        <div className="flex flex-col justify-start z-30 md:pb-[10vh] pl-0 lg:pl-10">
          <div className="flex flex-col pl-5 justify-center items-center md:justify-start md:items-start">
            <div className="flex flex-row justify-center bg-black/50 md:bg-blue-500/20 rounded-md z-30 mb-3">
              <a href="./" className="flex flex-row items-center">
                <span className="p-2 px-3 text-sm md:text-lg font-mono md:text-white/90 tracking-widest">#stay-curio</span>
              </a>
            </div>
            <h1 className="w-12/12 md:w-8/12 lg:w-8/12 text-4xl md:text-6xl lg:text-7xl uppercase font-bold mb-2 md:mb-0 text-white inline-block">
              We bring rwa<br/>to the masses
            </h1>
            <p className="px-2 w-full md:w-7/12 lg:w-5/12 md:mt-3 text-lg md:text-2xl font-thin text-white md:text-white lg:text-blue-200 text-center md:text-left">
        ...
        <div className="hidden md:flex flex-col absolute top-12 right-16 md:top-20 md:right-7 lg:top-10 lg:right-10 bg-black/50 text-white px-5 py-2 rounded-xs z-40">
          <p className="md:text-md lg:text-md font-light">First tokenized Super Car</p>
          <p className="md:text-2xl lg:text-2xl font-bold mb-1 text-blue-300">Ferrari F12 TDF</p>
          <p className="md:text-xs lg:text-sm font-thin text-white flex flex-row justify-between items-center border-t border-white/20 pt-1">
      ...
      <div className="grid grid-cols-12 gap-0 px-3 md:px-5 2xl:px-auto">
        ...
        <div className="col-span-12 sm:col-span-4 md:col-span-4">
          <div className="h-full md:border-r border-b border-blue-500/20 md:px-2 py-3">
            <div className='flex flex-col text-center md:text-left md:gap-2'>
              <h4 className="text-lg lg:text-xl font-light text-blue-400">
                Dedicated to Curio Invest
              </h4>
        ...
        <div className="col-span-6 sm:col-span-4 md:col-span-3 lg:col-span-2">
          <div className="h-full border-r border-b border-blue-500/20 md:px-5 py-3">
            <div className='flex flex-col gap-2 md:gap-1'>
              <h4 className="text-md lg:text-xl font-light text-blue-400 mb-1 text-center md:text-left">
                Community
              </h4>
        ...
        <div className="hidden md:block col-span-6 sm:col-span-4 md:col-span-3 lg:col-span-2">
          <div className="h-full border-r border-b border-blue-500/20 px-5 py-3">
            <div className='flex flex-col gap-2 md:gap-1'>
              <h4 className="text-md lg:text-xl font-light text-blue-400">
                Market Price
              </h4>
              ...
              <div className="font-extralight">
                ...
                <span className={"px-2 rounded-md text-sm " + (parseInt(marketData.priceChange) > 0 ? 'text-green-500' : 'text-red-500')}>
        ...
        <div className="hidden lg:block col-span-6 sm:col-span-4 md:col-span-2">
          <div className="h-full border-r border-b border-blue-500/20 px-5 py-3">
            <div className='flex flex-col gap-2 md:gap-1'>
              <h4 className="text-md md:text-xl font-light text-blue-400">
                Staking APY
              </h4>
              <div className="text-3xl font-bold text-white">
        ...
        <div className="col-span-6 sm:col-span-4 md:col-span-2">
          <div className="h-full border-b border-blue-500/20 px-5 py-3">
            <div className='flex flex-col gap-2 md:gap-2'>
              <h4 className="text-md lg:text-xl font-light text-blue-400 text-center md:text-left">
                Buy CGT
              </h4>
