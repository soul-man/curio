...
"
      >
        <a href="./" className="flex flex-row items-center space-x-3 z-10">
            <span className="text-md font-bold text-white">CURIOINFO &copy; {new Date().getFullYear()}</span>
        </a>
        ...
        <div className='pt-2 lg:pt-0'>
          ...
          <div className="text-blue-300/70">
            <div className="flex flex-col lg:flex-row items-center text-center mt-3 md:mt-0 gap-2">
              <span className="text-sm flex items-center justify-center text-blue-300/70">
                made with couriosity by Soulman <FaRegHeart className="mx-2 text-red-600 text-xl" />
                and some help of AI{' '}
              </span>
